...
#include "d3d12.h"
//*********************************************************
// Stripped and typedefed version of d3dx12.h
// Modifications Copyright (c) Tobias Lundstrom. In accordance with below license.

//////////////////////////////////////////////////////////////////////////////////////////////////
// TGL Descriptor Heap Helpers
//
//------------------------------------------------------------------------------------------------
namespace TGL 
{
	D3D12_CPU_DESCRIPTOR_HANDLE OffsetCpuDescriptor(D3D12_CPU_DESCRIPTOR_HANDLE& handle, INT count, UINT descSize);
	D3D12_GPU_DESCRIPTOR_HANDLE OffsetGpuDescriptor(D3D12_GPU_DESCRIPTOR_HANDLE& handle, INT count, UINT descSize);
}	

//////////////////////////////////////////////////////////////////////////////////////////////////
// D3Dx12 Implementation
//
//------------------------------------------------------------------------------------------------
